...
export function Founders() {
  return (
    <section id="founders" className="py-16 sm:py-20 md:py-32 relative overflow-hidden bg-gradient-to-br from-blue-50/20 via-white to-slate-50/50">
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8 relative z-10">
        ...
        <motion.div
          ...
          className="text-center max-w-3xl mx-auto mb-10 sm:mb-14 md:mb-20"
        >
        ...
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-10 md:gap-16">
          {founders.map((founder, index) => (
            <motion.div
              ...
              className="group relative bg-white rounded-3xl p-6 sm:p-8 md:p-12 shadow-[0_10px_40px_rgba(0,0,0,0.05)] hover:shadow-[0_30px_60px_rgba(0,0,0,0.1)] transition-all duration-500 hover:-translate-y-2 overflow-hidden"
            >
              {/* Avatar */}
              <div className="relative w-[140px] h-[140px] sm:w-[170px] sm:h-[170px] md:w-[200px] md:h-[200px] mx-auto mb-6 sm:mb-8">
              ...
              <div className="text-center">
                <h3 className="text-2xl sm:text-3xl font-extrabold text-dark mb-2 relative inline-block group">
                  {founder.name}
                ...
                <p className="text-sm sm:text-base text-gray-600 leading-relaxed mb-6 sm:mb-8">{founder.bio}</p>

                {/* Stats */}
                <div className="flex justify-center gap-6 sm:gap-8 md:gap-12 pt-6 sm:pt-8 border-t border-gray-100">

...
export function Testimonials() {
  return (
    <section id="testimonials" className="py-24 relative bg-gradient-to-br from-slate-50 via-white to-blue-50/20 overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="relative bg-gray-50 p-10 rounded-xl hover:-translate-y-1 hover:shadow-[0_15px_30px_rgba(0,0,0,0.08)] transition-all duration-300"
            >
              {/* Quote Mark */}
              ...
              {/* Content */}
              <p className="text-lg text-dark-light leading-relaxed mb-8 relative z-10">
                {testimonial.content}
              </p>
